...
class Incident {
	 ...
	 */
	public function __construct( $code = '', $message = '', $data = '', $channel = 'error_log', $throws = E_USER_ERROR ) {
		...
		$this->error = new \WP_Error( $args['code'], args['message'], args['data'] );
	 ...
	 * @return bool|void
	 */
	public static function action_die( $event ) {
